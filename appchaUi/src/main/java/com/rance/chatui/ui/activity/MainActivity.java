...
public class MainActivity extends AppCompatActivity {
    ...
    private ChatAdapter.onItemClickListener itemClickListener = new ChatAdapter.onItemClickListener() {
        ...
        public void onImageClick(View view, int position) {
            ...
            EventBus.getDefault().postSticky(imageUrl);//postSticky预先注册事件  等之后再注册事件的也能接收
            Log.i("图片地址",imageUrl);
            startActivity(new Intent(MainActivity.this, RoTseeActivity.class));
    ...
    private void LoadData() {
        ...
        messageInfo2.setImageUrl("http://tupian.enterdesk.com/2014/mxy/11/2/1/12.jpg");
