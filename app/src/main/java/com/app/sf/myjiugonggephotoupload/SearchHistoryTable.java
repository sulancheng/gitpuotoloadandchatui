...
public class SearchHistoryTable {
    ...
    private static SearchHistoryDatabase dbHelper;
    private SQLiteDatabase db;
    private  static SearchHistoryTable searchHistoryTable = null;

    private SearchHistoryTable(Context mContext) {
        dbHelper = new SearchHistoryDatabase(mContext);
    }
    public static SearchHistoryTable getSearchHistoryTable(Context mContext){

        if(dbHelper==null){
            searchHistoryTable = new SearchHistoryTable(mContext);
        }
